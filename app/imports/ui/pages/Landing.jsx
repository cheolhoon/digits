        ...
        <div className="digits-landing-background">
          <Grid container centered stackable columns={3}>
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header as='h3' inverted>This address book enables any number of users to register and save their business contacts. You can only see the contacts that you have created.</Header>
            </Grid.Column>
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header as='h3' inverted>Each time you make a contact with a contact, you can write a note that
                summarizes that conversation. This note is saved along with a timestamp with the contact.</Header>
            </Grid.Column>
